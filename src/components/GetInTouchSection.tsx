...
const GetInTouchSection = () => {
  ...
  return (
    <section
      id="contact"
      className="py-20 px-4 bg-gradient-to-br from-gray-50/50 to-gray-100/50 dark:from-gray-900/50 dark:to-gray-800/50"
    >
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Choose how youd like to connect with us. Our team is here to help
            you scale your outreach.
          </p>
        </motion.div>
            ...
            >
              <Card className="h-full border-0 shadow-2xl hover:shadow-3xl transition-all duration-300 bg-gradient-to-br from-background to-background/80 dark:from-gray-900 dark:to-gray-800 backdrop-blur-xl overflow-hidden relative">
                ...
                <CardContent className="p-8 text-center relative z-10">
                  <div
                    className={`rounded-2xl w-20 h-20 flex items-center justify-center mx-auto mb-6 bg-gradient-to-r ${option.gradient} text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
